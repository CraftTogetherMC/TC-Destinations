...
If you now run `/destination` to set a destination for your train,  
TC-Destinations will create a [route](https://wiki.traincarts.net/p/TrainCarts/PathFinding#Route_Manager) for the train,  
which first contains server2 and then the destination you want to reach.  
